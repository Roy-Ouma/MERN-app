...
import { writer } from "../utils/dummyData"; // NOTE: Should be 'writers' if more than one writer
...
const WriterPage = () => {
  ...
  // If 'writer' is a single object, use as is. If it's an array, find the correct writer:
  // const writer = writers.find(w => w._id === id);

  const followerIds = writer.followers.map((f) => f.followerId); // FIXED

  const numOfPages = 4; // Set this to the correct number of pages for your posts
